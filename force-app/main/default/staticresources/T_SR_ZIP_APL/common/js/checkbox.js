...
$(function () {
    ...
    if (scrName == "SJ100907") {
        if (parentScrName    == "SJ010213" || parentScrName == "SJ010214" || parentScrName == "SJ010215" || parentScrName == "SJ010217" ||
            parentScrName == "SJ010218" || parentScrName == "SJ010211" || parentScrName == "SJ010212" ) {
            $(":checkbox").click(ClickCheckBox_Siborikomi);
        } else if(parentScrName == "SJ010216") {
            $(":checkbox").click(ClickCheckBox);
        } else {
            $(":checkbox").click(ClickCheckBox_Siborikomi_Mikomi);
        }
...
function ClickCheckBox_Flg(ts) {
    ...
    // 2019/07/22 融合版フォルダ構成変更により修正 UPD START
    //var imgNonePath = checkboxJs.staticResourcePath + "/IMG/none.png"; // 2018/12/21 add 画像の静的リソース対応
    var imgNonePath = checkboxJs.staticResourcePath + "/images/none.png"; // 2018/12/21 add 画像の静的リソース対応
    // 2019/07/22 融合版フォルダ構成変更により修正 UPD START
