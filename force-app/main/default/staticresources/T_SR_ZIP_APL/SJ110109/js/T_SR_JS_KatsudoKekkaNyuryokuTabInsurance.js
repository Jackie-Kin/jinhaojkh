 ...
 * システム   : 次期営業支援システム全国版
 * 機能名     : 活動結果入力（保険）（S1）
 * ファイル名 : T_SR_JS_KatsudoKekkaNyuryokuTabInsurance.js
 *
...
$(function () {
    ...
    setTimeout(function () {
        ...
        spmOmit.calculate($('#current-insurance-kaisya'));
        spmOmit.calculate($('#current-insurance-hani'));
        spmOmit.calculate($('#prev-insurance-kaisya'));
        spmOmit.calculate($('#prev-insurance-hani'));
