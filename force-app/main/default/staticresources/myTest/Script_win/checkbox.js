...
$(function () {
    ...
    var parentScrName = $("#hidScreenID").val()
...
$(function () {
    $(".Koumoku_SelectData").click(function () {
        ...
        if (document.title == "SG90190" && $("#hidScreenID").val() != "SG30010" && $("#hidScreenID").val() != "SG30020") {
            return
        }
        //2017/09/22 mod end
...
function ClickCheckBox_Flg(ts) {
    ...
    $("#img_PnlKoumoku_Flag0").attr("src", "../img/none.png")
    $("#img_PnlKoumoku_Flag1").attr("src", "../img/none.png")
    $("#img_PnlKoumoku_Flag2").attr("src", "../img/none.png")
    // 2015/11/26 add start
    $("#img_PnlKoumoku_Flag3").attr("src", "../img/none.png")
    // 2015/11/26 add end
    //2018/01/30 add start
    $("#img_PnlKoumoku_Flag4").attr("src", "../img/none.png")
    //2018/01/30 add end
